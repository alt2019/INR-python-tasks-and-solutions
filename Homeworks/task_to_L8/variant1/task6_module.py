...
def make_result(control, probe_1, probe_2, var, condition = None):
	"""
	...
	tempc, ic, tc, up1, tp1, up2, tp2 = transform_initial(control, probe_1, probe_2)
...
def transform_initial(control, probe_1, probe_2):
	tempc, ic, tc = control[0::3], control[1::3], control[2::3]
	up1, tp1 = probe_1[0::2], probe_1[1::2]
	up2, tp2 = probe_2[0::2], probe_2[1::2]
	return tempc, ic, tc, up1, tp1, up2, tp2
...
def run(control, probe_1, probe_2, condition = None):
	...
	list3t = make_result(control, probe_1, probe_2, var = 1, condition = cond)
	print_report(list3t, 2)
