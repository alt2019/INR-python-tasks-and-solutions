...
def make_result(time, ic, tc, up1, tp1, up2, tp2, var, condition = None):
	"""
...
if __name__ == '__main__':
	...
	""" '=' is not allowed """
	condition = {"current": ">30", "temperature": "<40"}
	# condition = {"temperature": "<30"}
	# condition = {"current": ">20"}

	time = [ item for item in tc if ((item in tp1) and (item in tp2)) ]
	list1t = make_result(time, ic, tc, up1, tp1, up2, tp2, 1, condition)
